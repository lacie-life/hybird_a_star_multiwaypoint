...
namespace mrpt
{
    namespace math
    {
         ...
         */
        template <class T> inline void wrapTo2PiInPlace(T &a)
        {
            bool was_neg = a < 0;
         ...
         * \sa wrapToPi, wrapTo2Pi, unwrap2PiSequence
         */
        template <class T> inline T wrapTo2Pi(T a)
        {
            wrapTo2PiInPlace(a);
            return a;
        }
         ...
         */
        template <class T> inline T wrapToPi(T a)
        {
         ...
         * \sa wrapToPi,wrapTo2Pi, unwrap2PiSequence
         */
        template <class T> inline void wrapToPiInPlace(T &a)
        {
            a = wrapToPi(a);
        }
         ...
         * \sa wrapToPi
         */
        template <class VECTOR> void unwrap2PiSequence(VECTOR &x)
        {
         ...
         */
        template <class T> inline T angDistance(T from, T to)
        {
