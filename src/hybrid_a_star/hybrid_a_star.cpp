...
void HybridAStar::Init(double x_lower, double x_upper, double y_lower, double y_upper,
    ...
    std::cout << map_data_ << std::endl;

    std::cout << STATE_GRID_RESOLUTION_ << " " << MAP_GRID_RESOLUTION_ << std::endl;
    std::cout << MAP_GRID_SIZE_X_ << " " << MAP_GRID_SIZE_Y_ << std::endl;
    std::cout << STATE_GRID_SIZE_X_ << " " << STATE_GRID_SIZE_Y_ << std::endl;
...
bool HybridAStar::Search(const Vec3d &start_state, const Vec3d &goal_state) {
    ...
    std::cout << "Start Hybrid A Star Search" << std::endl;
